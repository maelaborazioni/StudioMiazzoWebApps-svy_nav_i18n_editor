...
function dc_delete(_event, _triggerForm) {
	globals.svy_mod_dialogs_global_showErrorDialog('Error', i18n.getI18NMessage('svy.dlg.deletingRecordNotAllowed'), i18n.getI18NMessage('svy.fr.lbl.ok'));
}
...
function dc_new(_event, _triggerForm) {
	globals.svy_mod_dialogs_global_showErrorDialog('Error', i18n.getI18NMessage('svy.dlg.addingRecordNotAllowed'), i18n.getI18NMessage('svy.fr.lbl.ok'));
}
